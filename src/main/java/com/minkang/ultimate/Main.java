...
KitManager kitManager = KitManager.getInstance();
        ...
        bindCmd("장사글", new com.minkang.ultimate.commands.PostCommand(this, com.minkang.ultimate.commands.PostCommand.Type.TRADE));
        bindCmd("거래글", new com.minkang.ultimate.commands.PostCommand(this, com.minkang.ultimate.commands.PostCommand.Type.DEAL));
